...
void Encoder_reader_simulink_initialize(void)
{
  ...
  /* External mode info */
  Encoder_reader_simulink_M->Sizes.checksums[0] = (1075882569U);
  Encoder_reader_simulink_M->Sizes.checksums[1] = (90042798U);
  Encoder_reader_simulink_M->Sizes.checksums[2] = (1961330023U);
  Encoder_reader_simulink_M->Sizes.checksums[3] = (1115154905U);
