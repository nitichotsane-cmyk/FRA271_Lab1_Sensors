...
void Encoder_reader_simulink_initialize(void)
{
  ...
  /* External mode info */
  Encoder_reader_simulink_M->Sizes.checksums[0] = (384008059U);
  Encoder_reader_simulink_M->Sizes.checksums[1] = (3317149739U);
  Encoder_reader_simulink_M->Sizes.checksums[2] = (599395693U);
  Encoder_reader_simulink_M->Sizes.checksums[3] = (3078964147U);
